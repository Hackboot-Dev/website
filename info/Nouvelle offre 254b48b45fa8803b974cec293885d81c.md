...
| Niveau | Disponibilité GPU | Support | Remplacement GPU | Crédits panne |
| --- | --- | --- | --- | --- |
...
### 📊 Options stockage haute performance
...
### 📦 Catalogue d'applications pré-installées
...
## 🌐 Services Réseau Premium

### 📊 IP & Connectivité

| Service | Description | Prix | Détails |
| --- | --- | --- | --- |
| **IPv4 additionnelle** | IP publique dédiée | **5€/mois** | • Géolocalisation France<br>• rDNS personnalisable<br>• Blacklist monitoring |
| **Bloc IPv4 /29** | 5 IPs utilisables | **25€/mois** | • Pour petits réseaux<br>• RIPE direct<br>• Justification simple |
| **Bloc IPv4 /28** | 13 IPs utilisables | **65€/mois** | • Multi-services<br>• BGP possible<br>• Whois personnalisé |
| **Bloc IPv4 /27** | 29 IPs utilisables | **145€/mois** | • Infrastructure<br>• AS privé possible<br>• Support RPKI |
| **IPv6 /48** | 65,536 réseaux | **Gratuit** | • Allocation immédiate<br>• BGP ready<br>• Native dual-stack |
| **IPv6 /32** | Entreprise | **99€/mois** | • Provider Independent<br>• Multi-sites<br>• RIPE member |

### 🔌 Bande Passante & Transit

| Service | Volume/Vitesse | Prix | Garanties |
| --- | --- | --- | --- |
| **Bande passante** | Au-delà quotas | **0,01€/GB** | • 95th percentile<br>• Burst autorisé<br>• CDN ready |
| **Trafic premium** | Peering direct | **0,008€/GB** | • Latence -30%<br>• Routes optimales<br>• SLA 99.99% |
| **Port 1 Gbps** | Non-mesuré | **99€/mois** | • Dédié garanti<br>• Full duplex<br>• 0% packet loss |
| **Port 10 Gbps** | Non-mesuré | **499€/mois** | • Fibre dédiée<br>• Redondant<br>• Monitoring inclus |
| **Port 25 Gbps** | Non-mesuré | **999€/mois** | • Ultra low latency<br>• LACP possible<br>• QoS avancé |
| **Port 100 Gbps** | Non-mesuré | **3999€/mois** | • Backbone direct<br>• Multi-path<br>• Engineers 24/7 |

---

## ⚖️ Load Balancing & HA

### 📊 Load Balancers Managés

|  | **LB-STARTER** | **LB-BUSINESS** | **LB-ENTERPRISE** | **LB-GLOBAL** |
| --- | --- | --- | --- | --- |
| **Backends max** | 5 | 20 | 100 | Illimité |
| **Requests/sec** | 10K | 50K | 200K | 1M+ |
| **SSL/TLS** | Let's Encrypt | + Wildcard | + EV/Custom | + HSM |
| **Protocoles** | HTTP/HTTPS | + TCP/UDP | + WebSocket | + gRPC/HTTP3 |
| **Health checks** | Basic | Advanced | Custom scripts | AI-powered |
| **Algorithmes** | Round-robin | + Least conn | + IP hash | + Custom |
| **Régions** | 1 | 1 | Multi-AZ | Multi-région |
| **DDoS protection** | Basic | Advanced | Premium | Enterprise |
|  |  |  |  |  |
| **Prix mensuel** | **29€** | **99€** | **299€** | **999€** |
| **Prix annuel** | **290€** | **990€** | **2990€** | **9990€** |
| **Setup** | Gratuit | Gratuit | Gratuit | Consulting |
...
| Service | Type | Utilisateurs | Prix | Caractéristiques |
| --- | --- | --- | --- | --- |
