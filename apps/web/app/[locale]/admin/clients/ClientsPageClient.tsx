...
// Description: Clients management page with CRUD operations - VMCloud only
...
function StatCard({
  ...
  return (
    <div className="p-5 bg-zinc-900/20 border border-zinc-900 hover:border-zinc-800 transition-all">
      <div className="flex items-center justify-between mb-3">
        <div className={`w-10 h-10 flex items-center justify-center border bg-zinc-900/50 ${color}`}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-zinc-800">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-2.5 text-sm font-medium text-zinc-400 hover:text-white border border-zinc-800 hover:border-zinc-700 transition-colors"
            >
            ...
            {!isViewMode && (
              <button
                type="submit"
                disabled={saving}
                className="flex items-center gap-2 px-6 py-2.5 text-sm font-medium bg-white text-black hover:bg-zinc-200 disabled:opacity-50 transition-colors"
              >
                {saving ? (
                  <>
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <div className="flex flex-1 gap-3">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-zinc-900 border border-zinc-800 text-white placeholder-zinc-600 focus:border-zinc-700 focus:outline-none"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-2.5 bg-zinc-900 border border-zinc-800 text-white focus:border-zinc-700 focus:outline-none"
          >
          ...
          <select
            ...
            className="px-4 py-2.5 bg-zinc-900 border border-zinc-800 text-white focus:border-zinc-700 focus:outline-none hidden md:block"
          >
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={handleSync}
            disabled={syncing}
            className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium bg-zinc-900 border border-zinc-800 text-white hover:bg-zinc-800 disabled:opacity-50 transition-colors"
          >
      ...
      <motion.div
        ...
        className="bg-zinc-900/20 border border-zinc-900"
      >
        {loading ? (
