...
const loadTranslations = (lang: string) => {
  return lang === 'fr' ? pricingFr : pricingEn;
};
  ...
  const pricingModels = [
    {
      ...
      icon: ClockIcon,
      color: 'blue' as const,
      name: translations.models?.hourly?.name,
      tagline: translations.models?.hourly?.tagline,
      description: translations.models?.hourly?.description,
      features: translations.models?.hourly?.features,
      bestFor: translations.models?.hourly?.bestFor,
      example: translations.models?.hourly?.example,
      savings: translations.models?.hourly?.savings
    },
    {
      id: 'monthly',
      icon: CalendarIcon,
      color: 'emerald' as const,
      name: translations.models?.monthly?.name,
      tagline: translations.models?.monthly?.tagline,
      description: translations.models?.monthly?.description,
      features: translations.models?.monthly?.features,
      bestFor: translations.models?.monthly?.bestFor,
      example: translations.models?.monthly?.example,
      savings: translations.models?.monthly?.savings
    },
    {
      id: 'annual',
      icon: TrophyIcon,
      color: 'purple' as const,
      name: translations.models?.annual?.name,
      tagline: translations.models?.annual?.tagline,
      description: translations.models?.annual?.description,
      features: translations.models?.annual?.features,
      bestFor: translations.models?.annual?.bestFor,
      example: translations.models?.annual?.example,
      savings: translations.models?.annual?.savings
    }
  ];
