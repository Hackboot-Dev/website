# Documentation Business - VMCloud

> **Base de connaissance stratégique et opérationnelle de VMCloud**
...
Ce dossier `/docs/business/` est la **source de vérité unique** pour toutes les informations stratégiques, financières et opérationnelles de VMCloud. Il sert à :
...
│   ├── OVH (non-cash)     : 1 500 000 € (24 mois)
...
👥 ÉQUIPE (6 personnes)
├── Fondateurs (non payés) : 3 (CEO, CTO, COO)
└── Contractors            : 3 (~30 200 €/mois total)
    ├── SRE                : 15 400 €/mois
    ├── DRH                : 7 800 €/mois
    ├── CRE                : 4 000 €/mois
    └── Virtualization     : 3 000 €/mois
...
⚠️ ALERTE CRITIQUE
Fin 2027 : Fin programme OVH + Fin différé prêt
→ Burn passera de 36K€ à 65-80K€/mois
→ Objectif : atteindre 55K€ MRR avant cette date
```
